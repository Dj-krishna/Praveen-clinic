...
<div class="hero-all-main-slider">
    <div class="hero-main-slider">
        <div class="hero3-section-area sp1">
            <div class="bg-img">
                <img src="assets/img/all-images/home/slide-1.jpg" alt="">
            </div>
          <div class="container">
        ...
        <div class="hero3-section-area sp1">
            <div class="bg-img">
                <img src="assets/img/all-images/home/slide-2.jpg" alt="">
            </div>
          <div class="container">
            <div class="row align-items-center">
              <div class="col-lg-8">
            ...
            <div class="row align-items-center">
              <div class="col-lg-6">
                <div class="hero-header">
                  ...
                  <div class="space20"></div>
                  <p>At Dr Praveen Reddy Clinic, we’re dedicated providing exceptional dental care that puts your smile first, with an team skilled professional.</p>
                  <div class="space28"></div>
                  <div class="btn-area1">
...
<section class="micon-section pt-60 md-pt-60">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4 col-md-12">
                                <!-- micon items start -->
                                <div class="micon-items micon-items-one wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                                    <div class="micon-icon">
                                        <figure>
                                            <img src="assets/img/all-images/book-appointment.png" alt="micon book appointment">
                                        </figure>
                                    </div> 
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M7.99992 0.833496C4.04188 0.833496 0.833252 4.04212 0.833252 8.00016C0.833252 11.9582 4.04188 15.1668 7.99992 15.1668C11.958 15.1668 15.1666 11.9582 15.1666 8.00016C15.1666 4.04212 11.958 0.833496 7.99992 0.833496ZM7.33325 5.3335C7.06359 5.3335 6.82052 5.49592 6.71732 5.74504C6.61415 5.99416 6.67119 6.2809 6.86185 6.47157L7.72379 7.3335L5.52851 9.52876C5.26817 9.7891 5.26817 10.2112 5.52851 10.4716C5.78887 10.7319 6.21097 10.7319 6.47133 10.4716L8.66659 8.2763L9.52852 9.13823C9.71919 9.3289 10.0059 9.38596 10.2551 9.28276C10.5042 9.17956 10.6666 8.9365 10.6666 8.66683V6.00016C10.6666 5.63198 10.3681 5.3335 9.99992 5.3335H7.33325Z" fill="#666"></path>
                            ...
                            <div class="col-lg-4 col-md-12">
                                <!-- micon items start -->
                                <div class="micon-items micon-items-two wow fadeInUp" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                                    <div class="micon-icon">
                                        <figure>
                                            <img src="assets/img/all-images/qualified-doctors.png" alt="micon qualified doctors">
                                        </figure>
                                    </div>
                                    <div class="micon-content">
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M7.99992 0.833496C4.04188 0.833496 0.833252 4.04212 0.833252 8.00016C0.833252 11.9582 4.04188 15.1668 7.99992 15.1668C11.958 15.1668 15.1666 11.9582 15.1666 8.00016C15.1666 4.04212 11.958 0.833496 7.99992 0.833496ZM7.33325 5.3335C7.06359 5.3335 6.82052 5.49592 6.71732 5.74504C6.61415 5.99416 6.67119 6.2809 6.86185 6.47157L7.72379 7.3335L5.52851 9.52876C5.26817 9.7891 5.26817 10.2112 5.52851 10.4716C5.78887 10.7319 6.21097 10.7319 6.47133 10.4716L8.66659 8.2763L9.52852 9.13823C9.71919 9.3289 10.0059 9.38596 10.2551 9.28276C10.5042 9.17956 10.6666 8.9365 10.6666 8.66683V6.00016C10.6666 5.63198 10.3681 5.3335 9.99992 5.3335H7.33325Z" fill="#666"></path>
                            ...
                            <div class="col-lg-4 col-md-12">
                                <!-- micon items start -->
                                <div class="micon-items micon-items-three wow fadeInUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                                    <div class="micon-icon">
                                        <figure>
                                            <img src="assets/img/all-images/services.png" alt="micon services">
                                        </figure>
                                    </div>
                                    <div class="micon-content">
                                        <h2>24/7 Services</h2>
  ...
  <div class="marquee-wrap">
    <div class="marquee-text">
      <div class="brand-single-box">
        <h3><img src="assets/img/elements/elements1.png" alt=""> Personalized Care</h3>
      </div>

      <div class="brand-single-box">
      <h3><img src="assets/img/elements/elements1.png" alt=""> Experienced Professionals</h3>
      </div>

    <div class="brand-single-box">
      <h3><img src="assets/img/elements/elements1.png" alt=""> Advanced Technology</h3>
    </div>

    <div class="brand-single-box">
      <h3><img src="assets/img/elements/elements1.png" alt=""> Preventive Care</h3>
    </div>

    <div class="brand-single-box">
      <h3><img src="assets/img/elements/elements1.png" alt=""> Patient-Centered Approach</h3>
    </div>
    ...
    <div class="row">
      <div class="col-lg-8 m-auto">
        <div class="heading4 text-center space-margin60">
          <h5 class="vl-section-subtitle">Services <svg xmlns="http://www.w3.org/2000/svg" width="13" height="8" viewBox="0 0 13 8" fill="none">
            <path d="M0.667969 4.00033H11.049M8.00137 7.33366L11.3346 4.00033L8.0013 0.666992" stroke="#02015A" stroke-width="1.5"/>
          </svg>
        </h5>
        <div class="space24"></div>
        <h2 class="vl-section-title text-anime-style-3">Our Specialized Treatments</h2>
        </div>
      </div>
    </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                        ...
                        <div class="about-one__img">
                            <img src="assets/img/all-images/home/dr-praveen-reddy.png" alt="">
                        </div>
                </div>
               ...
               <!--  <div class="about-one__inner">
                    ...
                    <div class="row py-4">
                      <h3 class="gradient-text mb-0" data-aos="fade-up" data-aos-duration="1200">Dr &nbsp;Praveen Reddy</h3>
                    </div>
                </div> -->
            </div>
            <div class="container">
  <div class="row">
    <h3 class="gradient-text" data-aos="fade-up" data-aos-duration="1200">Dr Praveen Reddy P</h3>
  </div>
</div>
        </section>
        <!--About One End -->  
...
<div class="contact1-section-area4 mb-5" style="background-image: url(assets/img/all-images/contact/contact-img1.png); background-position: center top; background-repeat: no-repeat; background-size: cover;">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
        <div class="contact-single-boxarea">
          <div class="row">
           ...
           <!--  <div class="col-lg-6 col-md-6" data-aos="zoom-in-up" data-aos-duration="1000">
            ...
            <div class="col-lg-6 col-md-6" data-aos="zoom-in-up" data-aos-duration="1100">
              <div class="single-box">
                <div class="icons">
                  <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                    <path d="M19.037 7.99935C20.3394 8.25344 21.5362 8.89036 22.4745 9.8286C23.4128 10.7668 24.0497 11.9637 24.3037 13.266M19.037 2.66602C21.7428 2.9666 24.2658 4.17824 26.1921 6.10203C28.1182 8.0258 29.3332 10.5474 29.637 13.2527M24.9704 27.9993C13.5565 27.9993 4.30371 18.7465 4.30371 7.33268C4.30371 6.81772 4.32255 6.30716 4.35956 5.80166C4.40204 5.22151 4.42328 4.93144 4.57531 4.66739C4.70123 4.4487 4.92438 4.2413 5.15168 4.13168C5.42612 3.99935 5.74622 3.99935 6.38639 3.99935H10.1428C10.6812 3.99935 10.9503 3.99935 11.1811 4.08795C11.3849 4.16622 11.5664 4.29334 11.7096 4.45815C11.8717 4.64472 11.9637 4.8977 12.1477 5.40363L13.7025 9.67942C13.9165 10.2681 14.0236 10.5624 14.0054 10.8416C13.9894 11.0878 13.9053 11.3248 13.7626 11.5261C13.6009 11.7544 13.3323 11.9155 12.7952 12.2378L10.9704 13.3327C12.5729 16.8645 15.4372 19.7325 18.9704 21.3327L20.0653 19.5079C20.3876 18.9707 20.5486 18.7021 20.7769 18.5404C20.9782 18.3977 21.2152 18.3136 21.4614 18.2976C21.7406 18.2795 22.035 18.3865 22.6237 18.6005L26.8994 20.1553C27.4053 20.3393 27.6584 20.4313 27.8449 20.5935C28.0097 20.7367 28.1369 20.9181 28.215 21.122C28.3037 21.3527 28.3037 21.6219 28.3037 22.1603V25.9167C28.3037 26.5568 28.3037 26.877 28.1713 27.1514C28.0617 27.3787 27.8544 27.6019 27.6357 27.7278C27.3716 27.8798 27.0816 27.9009 26.5014 27.9435C25.9958 27.9805 25.4853 27.9993 24.9704 27.9993Z" stroke="#1C293F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </div>
                <div class="text">
                  <h4>Phone</h4>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 m-auto">
        <div class="heading4 text-center space-margin60">
          <div class="heading4 text-center space-margin60">
            <h5 class="vl-section-subtitle">Testimonials <svg xmlns="http://www.w3.org/2000/svg" width="13" height="8" viewBox="0 0 13 8" fill="none">
              <path d="M0.667969 4.00033H11.049M8.00137 7.33366L11.3346 4.00033L8.0013 0.666992" stroke="#02015A" stroke-width="1.5"/>
            </svg>
          </h5>
          <div class="space24"></div>
          <h2 class="vl-section-title text-anime-style-3">Our clients always love us</h2>
          </div>
        </div>
      </div>
    </div>
...
<div class="faq-inner-section-area sp1">
    <div class="container">
      <div class="row">
          <div class="col-lg-12 m-auto">
             <div class="vl-blog-1-section-box heading4 text-center space-margin60">
                <h5 class="vl-section-subtitle">Have Questions <svg xmlns="http://www.w3.org/2000/svg" width="13" height="8" viewBox="0 0 13 8" fill="none">
                    <path d="M0.667969 4.00033H11.049M8.00137 7.33366L11.3346 4.00033L8.0013 0.666992" stroke="#02015A" stroke-width="1.5"/>
                  </svg>
                </h5>
                <div class="space24"></div>
                <h2 class="vl-section-title text-anime-style-3">Everything You Need to Know</h2>
             </div>
          </div>
       </div>
        <div class="row">
                            ...
                            <div class="faq-section-area">
                                <div class="row">
                                    <!-- <div class="col-lg-4">
                                      <div class="about-images-area">
                                        <div class="img1 image-anime reveal">
                                          <img src="assets/img/all-images/home/special-treatment.png" alt="">
                                        </div>
                                      </div>
                                    </div> -->
                                            ...
                                            <div class="accordion" id="accordionExample2">
                                                <div class="accordion-item">
                                                  <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                      Who is the best orthopedic surgeon in LB Nagar, Hyderabad?
                                                    </button>
                                                  </h2>
                                                  <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                                    <div class="accordion-body">
                                                     <p>Dr Praveen Reddy P is a highly experienced orthopedic surgeon at Agastya Hospitals in LB Nagar, Hyderabad, specializing in robotic joint replacement, sports injury treatment, and trauma surgeries. He is known for advanced surgical techniques and personalized patient care.</p> 
                                                    </div>
                                                  </div>
                                                </div>
                                                <div class="space20"></div>
                                                <div class="accordion-item">
                                                  <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                        What orthopedic treatments are available at Agastya Hospitals?
                                                    </button>
                                                  </h2>
                                                  <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                                    <div class="accordion-body">
                                                     <p>Agastya Hospitals provides comprehensive orthopedic treatments including robotic knee replacement, hip replacement surgery, arthroscopic ACL reconstruction, trauma surgery, fracture treatment, shoulder surgery, and physiotherapy rehabilitation.</p> 
                                                    </div>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="accordion-item">
                                                  ...
                                                  <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                                    <div class="accordion-body">
                                                      <p>Robotic knee replacement is an advanced orthopedic procedure that uses robotic technology to assist surgeons in performing precise joint replacement surgery. This technique improves implant alignment, reduces surgical trauma, and allows faster recovery compared to traditional knee replacement.</p> 
                                                    </div>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="accordion-item">
                                                    ...
                                                    <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                                      <div class="accordion-body">
                                                        <p>You should consult an orthopedic specialist if you experience persistent joint pain, knee pain, hip pain, sports injuries, fractures, ligament tears, arthritis, or difficulty walking and performing daily activities.</p> 
                                                      </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="accordion" id="accordionExample2">
                                                ...
                                                <div class="accordion-item">
                                                  ...
                                                  <div id="collapseSeven" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                                    <div class="accordion-body">
                                                     <p>Most patients begin walking within 24–48 hours after surgery. Full recovery generally takes 4–8 weeks depending on the patient’s health condition and physiotherapy rehabilitation program.</p> 
                                                    </div>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="accordion-item">
                                                  <h2 class="accordion-header">
                                                   ...
                                                   Do you treat sports injuries and ligament tears?
                                                    </button>
                                                  </h2>
                                                  <div id="collapseEight" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                                    <div class="accordion-body">
                                                     <p>Yes. Dr Praveen Reddy P provides advanced arthroscopic sports injury treatment including ACL reconstruction, PCL reconstruction, meniscus repair, rotator cuff repair, and shoulder instability surgery.</p> 
                                                    </div>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="accordion-item">
                                                  <h2 class="accordion-header">
                                                   ...
                                                   Do I need physiotherapy after orthopedic surgery?
                                                    </button>
                                                  </h2>
                                                  <div id="collapseNine" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                                    <div class="accordion-body">
                                                     <p>Yes. Physiotherapy and rehabilitation are essential after orthopedic surgeries such as joint replacement or ligament reconstruction to restore strength, mobility, and joint stability.</p> 
                                                    </div>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="accordion-item">
                                                  <h2 class="accordion-header">
                                                   ...
                                                   How can I book an appointment with Dr Praveen Reddy P?
                                                    </button>
                                                  </h2>
                                                  <div id="collapseTen" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                                    <div class="accordion-body">
                                                     <p>You can book an appointment with Dr Praveen Reddy P at Agastya Hospitals through the website appointment form, phone call, or WhatsApp consultation for orthopedic evaluation and treatment.</p> 
                                                    </div>
                                                  </div>
                                                </div> 
...
<style>
  ...
  #appointmentForm .input-area input.input-error,
  #appointmentForm .input-area select.input-error {
    border-color: #e74c3c !important;
    box-shadow: 0 0 0 2px rgba(231,76,60,0.12);
  }
  #appointmentForm .input-area input:focus,
  #appointmentForm .input-area select:focus {
    border-color: #02015A !important;
    box-shadow: 0 0 0 2px rgba(2,1,90,0.10);
  }
