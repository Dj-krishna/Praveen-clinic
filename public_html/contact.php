     ...
     <!--  <div class="row">
        <div class="col-lg-8 m-auto">
          <div class="heading4 text-center space-margin60">
            <h5 class="vl-section-subtitle">Need any help?
          </h5>
          <div class="space24"></div>
          <h2 class="vl-section-title text-anime-style-3">Contact Us</h2>
          </div>
        </div>
      </div> -->
      <div class="row mb-5">
        <div class="col-lg-8 col-md-6">
          <iframe style="height:300px;width:100%;border:0;" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=Dr+Praveen+Reddy+P+-+Best+Orthopedic+Surgeon+in+LB+Nagar&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe>
        </div>
        <div class="col-lg-4 col-md-6">
            <div class="conatct-widget-boxarea">
                <h5>Address</h5>
                <div class="textarea">
                    <div class="icons">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M14.05 6C15.0268 6.19057 15.9244 6.66826 16.6281 7.37194C17.3318 8.07561 17.8095 8.97326 18 9.95M14.05 2C16.0793 2.22544 17.9716 3.13417 19.4163 4.57701C20.8609 6.01984 21.7721 7.91101 22 9.94M18.5 21C9.93959 21 3 14.0604 3 5.5C3 5.11378 3.01413 4.73086 3.04189 4.35173C3.07375 3.91662 3.08968 3.69907 3.2037 3.50103C3.29814 3.33701 3.4655 3.18146 3.63598 3.09925C3.84181 3 4.08188 3 4.56201 3H7.37932C7.78308 3 7.98496 3 8.15802 3.06645C8.31089 3.12515 8.44701 3.22049 8.55442 3.3441C8.67601 3.48403 8.745 3.67376 8.88299 4.05321L10.0491 7.26005C10.2096 7.70153 10.2899 7.92227 10.2763 8.1317C10.2643 8.31637 10.2012 8.49408 10.0942 8.64506C9.97286 8.81628 9.77145 8.93713 9.36863 9.17882L8 10C9.2019 12.6489 11.3501 14.7999 14 16L14.8212 14.6314C15.0629 14.2285 15.1837 14.0271 15.3549 13.9058C15.5059 13.7988 15.6836 13.7357 15.8683 13.7237C16.0777 13.7101 16.2985 13.7904 16.74 13.9509L19.9468 15.117C20.3262 15.255 20.516 15.324 20.6559 15.4456C20.7795 15.553 20.8749 15.6891 20.9335 15.842C21 16.015 21 16.2169 21 16.6207V19.438C21 19.9181 21 20.1582 20.9007 20.364C20.8185 20.5345 20.663 20.7019 20.499 20.7963C20.3009 20.9103 20.0834 20.9262 19.6483 20.9581C19.2691 20.9859 18.8862 21 18.5 21Z" stroke="#31353D" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                          </svg>
                    </div>
                    <div class="text">
                        <a href="tel:+91-9459108108">+91-9459108108</a>
                    </div>
                </div>
...
India.</a>
        ...
        <!-- <div class="col-lg-4 col-md-6">
            <div class="conatct-widget-boxarea">
                ...
                <div class="textarea">
                    ...
                    <div class="text">
                        <a href="tel:+202-9393-939399">+202-9393-9393 99</a>
                    </div>
                </div>
                ...
                <div class="textarea">
                    ...
                    <div class="text">
                        <a href="tel:+202-9393-939399">USA Address - 254 Chapman Rd, Ste 208 #13379 Katche, Melaware 19702</a>
                    </div>
                </div>
                ...
                <div class="textarea">
                    ...
                    <div class="text">
                        <a href="mailto:infologistic@example.com">infologistic@example.com</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="single-box">
                    <div class="icons">
                      ...
                      <path d="M18.0219 8.8273C19.2962 9.0759 20.4671 9.69904 21.385 10.617C22.303 11.5349 22.9261 12.7059 23.1746 13.98M18.0219 3.60938C20.6691 3.90346 23.1376 5.08888 25.0222 6.97104C26.9066 8.85318 28.0953 11.3202 28.3926 13.967M23.8269 28.3945C12.66 28.3945 3.60742 19.3419 3.60742 8.17506C3.60742 7.67124 3.62585 7.17173 3.66207 6.67716C3.70363 6.10957 3.72441 5.82578 3.87314 5.56744C3.99634 5.35348 4.21466 5.15057 4.43705 5.04333C4.70555 4.91386 5.01871 4.91386 5.64504 4.91386H9.32017C9.84686 4.91386 10.1102 4.91386 10.336 5.00054C10.5354 5.07711 10.7129 5.20148 10.8531 5.36273C11.0117 5.54527 11.1017 5.79276 11.2817 6.28775L12.8028 10.471C13.0122 11.0469 13.117 11.3349 13.0992 11.6081C13.0836 11.849 13.0013 12.0808 12.8617 12.2777C12.7034 12.5011 12.4407 12.6587 11.9152 12.974L10.1298 14.0452C11.6977 17.5007 14.5 20.3066 17.9567 21.8721L19.028 20.0868C19.3433 19.5612 19.5008 19.2985 19.7242 19.1403C19.9211 19.0007 20.1529 18.9184 20.3939 18.9027C20.667 18.885 20.9551 18.9897 21.531 19.1991L25.7142 20.7203C26.2091 20.9003 26.4567 20.9903 26.6392 21.1489C26.8005 21.289 26.9249 21.4666 27.0013 21.666C27.0881 21.8917 27.0881 22.1551 27.0881 22.6818V26.3569C27.0881 26.9832 27.0881 27.2964 26.9586 27.5649C26.8513 27.7873 26.6485 28.0057 26.4346 28.1288C26.1761 28.2775 25.8924 28.2983 25.3248 28.3399C24.8302 28.3761 24.3307 28.3945 23.8269 28.3945Z" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
      ...
      <!-- <div class="row">
        <div class="col-lg-12">
          <iframe style="height:400px;width:100%;border:0;" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=Dr+Praveen+Reddy+P+-+Best+Orthopedic+Surgeon+in+LB+Nagar&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe>
        </div>
      </div> -->
    </div>
  </div>
