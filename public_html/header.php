              ...
              <div class="col-lg-5 col-md-6 col-6">
                <div class="vl-hero-btn d-none d-lg-block text-end">
                  <div class="btn-area1">
                    ...
                    <a href="contact.php" class="vl-btn4">Book Appointment <span><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                              ...
                              <!-- <li><a href="services.php">Our Services</a> </li> -->
                               <li class="has-dropdown">
                                <a href="services.php">Our Services <span class="arrow-size"><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                                  <ul class="sub-menu">
                                      <li class="has-dropdown">
                                          <a href="services.php">Robotic Knee Replacement <span class="arrow-size"><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                                            <ul class="sub-menu">
                                      ...
                                      <li class="has-dropdown">
                                          <a href="services.php">Joint Replacement <span class="arrow-size"><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                                            <ul class="sub-menu">
                                                <li><a href="#">Total Knee Replacement</a></li>
                                                <li><a href="#">Partial knee Replacement</a></li>
                                                <li><a href="#">Total Hip Replacement</a></li>
                                                <li><a href="#">Shoulder and Elbow Replacement</a></li>
                                            </ul>
                                      </li>

                                      <li class="has-dropdown">
                                          <a href="services.php">Trauma Surgeries <span class="arrow-size"><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                                            <ul class="sub-menu">
                                                <li><a href="#">Complex Trauma surgery</a></li>
                                                <li><a href="#">Pediatric Trauma Surgery</a></li>
                                                <li><a href="#">Revision Trauma (Surgery)</a></li>
                                                <li><a href="#">Nonunion surgery</a></li>
                                                <li><a href="#">Malunion Surgeries</a></li>
                                            </ul>
                                      </li>

                                      <li class="has-dropdown">
                                          <a href="services.php">Sports Medicine <span class="arrow-size"><i class="fa-solid fa-angle-down d-lg-inline d-none"></i></span></a>
                                            <ul class="sub-menu">
                                                <li><a href="#">Arthroscopic ACL Reconstruction</a></li>
                                                <li><a href="#">Arthroscopic PCL Reconstruction</a></li>
                                                <li><a href="#">Arthroscopic Meniscal Repair</a></li>
                                                <li><a href="#">Arthroscopic Rotator Cuff Repair</a></li>
                                                <li><a href="#">Arthroscopic Bankart Repair</a></li>
                                            </ul>
                                      </li>
