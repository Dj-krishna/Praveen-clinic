    ...
    <div class="vl-offcanvas-wrapper">
        <div class="vl-offcanvas-header d-flex justify-content-between align-items-center mb-90">
            <div class="vl-offcanvas-logo">
                <a href="index.html"><img src="assets/img/logo/dr-praveen-reddy-logo.png" alt=""></a>
            </div>
      ...
      <div class="row align-items-center">
          ...
          <div class="col-lg-8">
             <div class="doctor-content">
              ...
              <h4>Dr Praveen Reddy P</h4>

              <p><b>MBBS, Diploma in Orthopaedics, Orthopaedic surgeon</b></p>

             <p>Dr Praveen Reddy P is a highly respected Senior Orthopaedic Surgeon and Clinical Leader at Agastya Hospitals, LB Nagar, Hyderabad. With qualifications of MBBS and MS (Orthopaedics), Dr Praveen Reddy P has built a strong reputation for delivering advanced orthopedic care and helping patients recover from complex bone, joint, and musculoskeletal conditions. </p>
...
<img src="https://cdn-icons-png.flaticon.com/512/2910/2910791.png">
  ...
  <div class="row">
    <h3 class="gradient-text" data-aos="fade-up" data-aos-duration="1200">Expertise.  Compassion.  Trust.  Care.</h3>
  </div>
</div>
</div>
<!--===== ABOUT AREA ENDS =======-->
...
<h6 class="fw-bold">Expertise Services</h6>
...
<div class="col-lg-4 about-stats">
...
<li>MBBS at Kasturba Medical College</li>
                                                ...
                                                <div class="accordion-item">
                                                  <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix">
                                                      Who is Dr Praveen Reddy P?
                                                    </button>
                                                  </h2>
                                                  <div id="collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                                    <div class="accordion-body">
                                                     <p>Dr Praveen Reddy P is a senior orthopedic surgeon at Agastya Hospitals in LB Nagar, Hyderabad specializing in joint replacement, trauma surgery, and sports injury treatment.</p> 
                                                    </div>
                                                  </div>
                                                </div>
                                                <div class="space20"></div>
                                                <div class="accordion-item">
                                                  <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                                        What are Dr Praveen Reddy P’s qualifications?
                                                    </button>
                                                  </h2>
                                                  <div id="collapseSeven" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                                    <div class="accordion-body">
                                                     <p>He holds MBBS and MS in Orthopaedics and has extensive experience treating bone and joint disorders.</p> 
                                                    </div>
                                                  </div>
                                                </div>
                                                <div class="space20"></div>
                                                <div class="accordion-item">
                                                  <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                                       What orthopedic treatments does Dr Praveen Reddy P provide?
                                                    </button>
                                                  </h2>
                                                  <div id="collapseEight" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                                    <div class="accordion-body">
                                                      <p>He offers robotic knee replacement, hip replacement surgery, arthroscopic ligament reconstruction, trauma surgery, fracture treatment, and arthritis care.</p> 
                                                    </div>
                                                  </div>
                                                </div>
                                                <div class="space20"></div>
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header">
                                                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                                                       Does Dr Praveen Reddy P perform robotic joint replacement surgery?
                                                      </button>
                                                    </h2>
                                                    <div id="collapseNine" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                                      <div class="accordion-body">
                                                        <p>Yes, he specializes in advanced robotic knee replacement and robotic hip replacement surgeries for improved surgical accuracy and faster recovery.</p> 
                                                      </div>
                                                    </div>
                                                  </div>
                                                  <div class="space20"></div>
                                                  <div class="accordion-item">
                                                    <h2 class="accordion-header">
                                                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
                                                       Where does Dr Praveen Reddy P practice?
                                                      </button>
                                                    </h2>
                                                    <div id="collapseTen" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                                      <div class="accordion-body">
                                                       <p>Dr Praveen Reddy P practices at Agastya Hospitals in LB Nagar, Hyderabad.</p> 
                                                      </div>
                                                    </div>
                                                  </div>
                                              </div>
